...
public class Util {
	...
	public static Cell GetCellInfo(Context context){
	    ...
	    CellLocation cellLocation  =  mTelNet.getCellLocation();
	    if (cellLocation == null){
	    	...
	    	if(cellLocation instanceof GsmCellLocation){
			    ...
			    cell = new Cell(cid, lac);
		    } else if(cellLocation instanceof CdmaCellLocation){
		    	CdmaCellLocation cdmaCellLocation = (CdmaCellLocation)cellLocation;
		    	cdmaCellLocation.getBaseStationId();
		    	int cid = cdmaCellLocation.getBaseStationLatitude();
			    int lac = cdmaCellLocation.getBaseStationLongitude();
			    cell = new Cell(cid, lac);
		    }
	    }
	    return cell;
